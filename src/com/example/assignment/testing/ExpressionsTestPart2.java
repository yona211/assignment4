...
import com.example.assignment.binary.*;
import com.example.assignment.unary.*;
...
public class ExpressionsTestPart2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            e = new Div(new Sin(new Var("x")), new Sin(new Var("x")));
        ...
        try {
            ...
            // however : we will accept answers that are in the range of : value >= -0.7 &&
            // value <= -0.6
        ...
        try {
            ...
            Expression ee3 = new Mul(new Pow(new Var("x"), new Num(2)), new Pow(new Var("x"), new Num(2))); // x^2 *
                                                                                                             // x^2
        ...
        try {
            ...
            e = new Mul(new Mul(new Var("x"), new Num(4)), new Mul(new Var("x"), new Num(20)));
        ...
        try {
            ...
            // differentiate by "y"
            // produces 0
            e = new Plus(new Mul(new Var("x"), new Num(100)), new Mul(new Var("x"), new Num(20)));
        ...
        // From infi : (-sin(x)) * sin(x) + cos(x) * cos(x) = -sin(x)^2 + cos(x)^2 =
        // cos(x)^2 - sin(x)^2
        ...
        try {
            ...
            e = new Mul(new Neg(new Cos(new Var("x"))), new Neg(new Sin(new Var("x"))));
            e = e.differentiate("x");
            assignment.clear();
            assignment.put("x", 0.0);
            value = e.evaluate(assignment);
        ...
        try {
            ...
            e = new Mul(new Num(-1), new Pow(new Var("e"), new Mul(new Var("x"), new Num(-1)))); // -e^(-x)
        ...
        try {
            ...
            e = new Pow(new Var("e"), new Mul(new Var("x"), new Num(2))); // e^(2x)
        ...
        try {
            ...
            e = new Div(new Pow(new Var("e"), new Mul(new Var("x"), new Num(3))), new Pow(new Var("e"), new Var("x")));
            assignment.clear();
