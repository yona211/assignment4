    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (s.equals("(((x+y)+z)^2.0)")) {
                ...
                System.out.println("wrong test 1");
            }
        }
        ...
        try {
            ...
            if (s.equals("(((x+y)+(z+w))^4.0)")) {
                ...
                System.out.println("wrong test 2");
            }
        }
        ...
        try {
            ...
            if (value == 234256.0) {
                ...
                System.out.println("wrong test 3");
            }
        }
        ...
        try {
            ...
            if (!ans) {
                ...
                System.out.println("wrong test 4");
            }
        }
        ...
        try {
            ...
            if (value == 1) {
                ...
                System.out.println("wrong test 5");
            }
        }
        ...
        try {
            ...
            if (value >= 0.16 && value <= 0.17) {
                ...
                System.out.println("wrong test 6");
            }
        }
        ...
        try {
            ...
            if (value == -2) {
                ...
                System.out.println("wrong test 7");
            }
        ...
        try {
            ...
            if (value == 2) {
                ...
                System.out.println("wrong test 8");
            }
        }
        ...
        try {
            ...
            if (value == 4) {
                ...
                System.out.println("wrong test 9");
            }
        }
        ...
        try {
            ...
            if (value == 4) {
                ...
                System.out.println("wrong test 10");
            }
        }
        ...
        try {
            ...
            // -2 * 4 = - 8
            // ans is : -8
            Expression e9 = new Mul(new Neg(new Var("x")), new Neg(new Neg(new Var("y"))));
            assignment.clear();
            ...
            if (value == -8) {
                ...
                System.out.println("wrong test 11");
            }
        }
        ...
        try {
            ...
            if (value == 0) {
                ...
                System.out.println("wrong test 12");
            }
        }
        ...
        try {
            ...
            if (value == -2) {
                ...
                System.out.println("wrong test 13");
            }
        }
        catch (Exception exp) {
        ...
        try {
            ...
            if (value >= 1.4 && value <= 1.5) {
                ...
                System.out.println("wrong test 14");
            }
        }
        ...
        try {
            ...
            if (value == 1) {
                ...
                System.out.println("wrong test 15");
            }
        }
        ...
        try {
            // -----(-2) plus -----(1) = 1
            // ans is : 1
            e14 = new Plus(new Neg(new Neg(new Neg(new Neg(new Neg(new Num(-2)))))),
            ...
            if (value == 1) {
                ...
                System.out.println("wrong test 16");
            }
        ...
        try {
            ...
            if (vars == null || vars.size() == 0) {
                ...
                System.out.println("wrong test 17");
            }
        }
